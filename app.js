...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// challenges.style.backgroundColor = "red";
// challenges.querySelectorAll('div').forEach(element => {
//     element.style.backgroundColor = "green";
//     element.classList.add("lkfdjlsjfksdlk");
// });
// document.querySelectorAll(".challengeHolder").forEach(element => {
//     element.classList.add("jfdksjfj");
// });
...
// challenges.addEventListener('scroll', () => {
//   const scrollTop = challenges.scrollTop;
// //   const image1 = document.querySelector('.scrollable-div img:nth-child(1)');
// //   const image2 = document.querySelector('.scrollable-div img:nth-child(2)');
// const image1 = forestOnEdgeImage;
// const image2 = threeForestsImage;

//   // Calculate the vertical center of each image
//   const image1Center = image1.offsetTop + image1.offsetHeight / 2;
//   const image2Center = image2.offsetTop + image2.offsetHeight / 2;

//   // Determine which image is closer to the current scroll position
//   const distanceToImage1 = Math.abs(scrollTop - image1Center);
//   const distanceToImage2 = Math.abs(scrollTop - image2Center);

//   if (distanceToImage1 < distanceToImage2) {
//     // Scroll to the position of the closest image (image1)
//     challenges.scrollTop = image1.offsetTop;
//   } else {
    //     // Scroll to the position of the closest image (image2)
//     challenges.scrollTop = image2.offsetTop;
//   }
// });
